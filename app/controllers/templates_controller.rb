...
class TemplatesController < ApplicationController
  ...
  def edit
    ...
    if user_signed_in?
      ...
      @brand_logo_url = account.account_configs.find_by(key: AccountConfig::BRAND_LOGO_URL_KEY)&.value || ENV.fetch('WIPPLI_SIGN_LOGO_URL', '/wippli-sign-logo.svg')
      ...
      @brand_logo_url = ENV.fetch('WIPPLI_SIGN_LOGO_URL', '/wippli-sign-logo.svg')
